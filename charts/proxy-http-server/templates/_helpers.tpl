...
*/}}
{{- define "intersect-proxy-http-server.image" -}}
...
*/}}
{{- define "intersect-proxy-http-server.imagePullSecrets" -}}
...
*/}}
{{- define "intersect-proxy-http-server.serviceAccountName" -}}
...
*/}}
{{- define "intersect-proxy-http-server.ingress.certManagerRequest" -}}
