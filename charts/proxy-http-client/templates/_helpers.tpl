...
*/}}
{{- define "intersect-proxy-http-client.image" -}}
...
*/}}
{{- define "intersect-proxy-http-client.imagePullSecrets" -}}
...
*/}}
{{- define "intersect-proxy-http-client.serviceAccountName" -}}
...
*/}}
{{- define "intersect-proxy-http-client.ingress.certManagerRequest" -}}
